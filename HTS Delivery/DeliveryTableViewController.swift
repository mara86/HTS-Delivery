...
class DeliveryTableViewController: UITableViewController {
    ...
    @IBOutlet weak var deliveryInstructions: UITextView!
    ...
    @IBAction func save(_ sender: Any) {
        ...
        if let customer=Customer.retrieveCustomer(),Customer.retrieveCustomerStatus()
        {
        let deliveryInfo=DeliveryInfo()
        deliveryInfo.address=address.text
        deliveryInfo.lastName=customer.lastName
        deliveryInfo.firstName=customer.firstName
        deliveryInfo.apt=apt.text
        deliveryInfo.telephone=customer.phone
        deliveryInfo.id=customer.customerId
        deliveryInfo.instructions=deliveryInstructions.text
    ...
    override func viewDidLoad() {
        ...
        deliveryInstructions.layer.borderColor=UIColor(displayP3Red: 0, green: 0, blue: 0, alpha: 0.2).cgColor
        deliveryInstructions.layer.borderWidth=1
        deliveryInstructions.layer.cornerRadius=5
    ...
    {
        deliveryInstructions.resignFirstResponder()
